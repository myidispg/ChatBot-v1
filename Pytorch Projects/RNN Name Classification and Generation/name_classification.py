...
The extra dimension is because PyTorch assumes everything is in batches - we’re using a batch size of 1 here.
"""
import torch
...
To run a step of this network we need to pass an input
 ...
 We’ll get back the output (probability of each language) and a next
