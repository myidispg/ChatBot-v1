...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 21 17:53:05 2019
...
embeds = nn.Embedding(2, 5) # 2 words, 5 dimensions
...
"""
The CBOW model is as follows. Given a target word wi and an N context window
 on each side, wi−1,…,wi−N and wi+1,…,wi+N, referring to all context words 
...
for i in range(2, len(raw_text) - 2):
    context = [raw_text[i-1], raw_text[i-1], raw_text[i+1], raw_text[i+2]]
    target = raw_text[i]
